...
<a name="gii_q2">_**Q: What kind of software will we be using for this internship?**_<a/>
...
<a name="gii_q3">_**Q: Where can I find more information about this internship?**_<a/>
...
<a name="gii_q4">_**Q: What are the hours of the internship?**_<a/>
...
<a name="gii_q5">_**Q: Is this a paid internship?**_<a/>
...
<a name="gii_q6">_**Q: What happens after the initial steps?**_<a/>
...
<a name="gii_q7">_**Q: If I'm an international student, how soon can I get my paperwork required by my visa?**_<a/>
...
<a name="gii_q8">_**Q: How many pull requests and issues in total do I need to make to finish the steps?**_<a/>
...
<a name="tiq_q2">_**Q: How can I enable the Virtualization in order to turn vagrant on?**_<a/>
...
<a name="tiq_q3">_**Q: Why is the "Submit" button not showing up when I try to submit my survey?**_<a/>
...
<a name="tiq_q4">_**Q: Why does Firefox say “Unable to connect” when I try to load my community?**_<a/>
...
<a name="tiq_q5">_**Q: When I first run BeLL with the `vagrant up` command the download fails, why?**_<a/>
...
<a name="tiq_q6">_**Q: I named my repo incorrectly by not naming it &lt;username&gt;.github.io, can I rename it or I need to delete it?**_<a/>
...
<a name="tiq_q7">_**Q: What do I do if I already have a github.io with my username?**_<a/>
...
<a name="tiq_q8">_**Q: What do I do if I am on Unix/Mac/Linux and accidentally give root permissions, corrupting the installation of the vagrant vm?**_<a/>
In ```git bash``` type: 
```
cd ole--vagrant-vi
vagrant destroy -f
